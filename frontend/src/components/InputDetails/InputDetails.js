                            ...
                            <Row className="g-3">
                                ...
                                <Col sm={1}>
                                    <Form.Group className="mb-3" controlId="prefix">
                                        ...
                                        <Form.Control type="text" placeholder="Mr" aria-label="prefix"
                                                      aria-describedby="basic-addon1" {...register('prefix', {
                                            required: '*Required',
                                            maxLength: {
                                        ...
                                        <div className="invalidInput">
                                            <p>{formState.errors.prefix && formState.errors.prefix.message}</p></div>
                                    </Form.Group>
                                </Col>
                                ...
                                <Col sm={5}>
                                    <Form.Group className="mb-3" controlId="lastName">
                                        ...
                                        <div className="invalidInput">
                                            <p>{formState.errors.lastName && formState.errors.lastName.message}</p>
                                        </div>
                                    </Form.Group>
                                </Col>
                                ...
                                <Col sm={5}>
                                    <Form.Group className="mb-3" controlId="contactNumber">
                                        ...
                                        <Form.Control type="number" placeholder="Please enter your phone number"
                                ...
                                <Col sm={10}>
                                    <Form.Group className="mb-3" controlId="addressLine1">
                                        ...
                                        <Form.Control type="text" placeholder="Please enter your street address"
                                                      aria-label="Address line 1" aria-describedby="basic-addon1"
                                        ...
                                        <div className="invalidInput">
                                            <p>{formState.errors.addressLine1 && formState.errors.addressLine1.message}</p>
                                        </div>
                                    </Form.Group>
                                </Col>
                                ...
                                <Col sm={10}>
                                    <Form.Group className="mb-3" controlId="addressLine2">
                                        ...
                                        <Form.Control type="text" placeholder="Please enter your street address"
                                                      aria-label="Address line 2" aria-describedby="basic-addon1"
                                ...
                                <Col sm={5}>
                                    <Form.Group className="mb-3" controlId="city">
                                        ...
                                        <Form.Control type="text" placeholder="Please enter your city" aria-label="City"
                                        ...
                                        />
                                        <div className="invalidInput">
                                            <p>{formState.errors.city && formState.errors.city.message}</p></div>
                                    </Form.Group>
                                </Col>
                                ...
                                <Col sm={5}>
                                    <Form.Group className="mb-3" controlId="postcode">
                                        ...
                                        <Form.Control type="text" placeholder="Please enter your postcode"
                                        ...
                                        <div className="invalidInput">
                                            <p>{formState.errors.postcode && formState.errors.postcode.message}</p>
                                        </div>
                                    </Form.Group>
                                </Col>
                            </Row>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <Form.Select
                                                    ...
                                                    <option style={{display: 'none'}} value="">Select Vehicle Type
                                                    </option>
                                                ...
                                                <div className="invalidInput">
                                                    <p>{formState.errors.vehicleType && formState.errors.vehicleType.message}</p>
                                                </div>
                                            </Col>
                                        </Row>
                                    </Form.Group>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <Form.Select
                                                    ...
                                                    <option style={{display: 'none'}} value="">Select Engine Size
                                                    </option>
                                                ...
                                                <div className="invalidInput">
                                                    <p>{formState.errors.engineSize && formState.errors.engineSize.message}</p>
                                                </div>
                                            </Col>
                                        </Row>
                                    </Form.Group>
                                ...
                                <Col sm={12}>
                                    <Form.Group className="mb-3" controlId="currentVehicleValue">
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <Form.Control type="number" placeholder="£" aria-label="current value"
                                                              aria-describedby="basic-addon1"
                                                ...
                                                <div className="invalidInput">
                                                    <p>{formState.errors.currentVehicleValue && formState.errors.currentVehicleValue.message}</p>
                                                </div>
                                            </Col>
                                        </Row>
                                    </Form.Group>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <Form.Control type="date" placeholder=""
                                                              aria-label="Vehicle register date"
                                                              aria-describedby="basic-addon1"
                                                ...
                                                <div className="invalidInput">
                                                    <p>{formState.errors.dateVehicleRegistered && formState.errors.dateVehicleRegistered.message}</p>
                                                </div>
                                            </Col>
                                        </Row>
                                    </Form.Group>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <Form.Select
                                                    ...
                                                    <option style={{display: 'none'}} value="">Select Additional
                                                        Drivers
                                                    </option>
                                                ...
                                                <div className="invalidInput">
                                                    <p>{formState.errors.additionalDrivers && formState.errors.additionalDrivers.message}</p>
                                                </div>
                                            </Col>
                                        </Row>
                                    </Form.Group>
                                    ...
                                    <Form.Group className="mb-3" controlId="usedCommercialPurposes">
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                ...
                                                <div className="invalidInput">
                                                    <p>{errors.usedCommercialPurposes?.type === "required" &&
                                    ...
                                    <Form.Group className="mb-3" controlId="usedOutsideState">
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                ...
                                                <Form.Label className="labelstyle">No</Form.Label>
                                                <div className="invalidInput">
                                                    <p>{errors.usedOutsideState?.type === "required" &&
                                                    "*Please select an Option"}</p></div>
                                            </Col>
                                        </Row>
                                    </Form.Group>
